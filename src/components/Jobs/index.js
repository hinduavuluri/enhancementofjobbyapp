...
class Jobs extends Component {
  ...
  onChangeLocationInput = event => {
    this.setState({locationInput: event.target.id}, this.getJobDetails)
  }
    ...
    <div className="location-container">
      <div className="location-item">
        <input
          ...
          value="hyderabad"
        />
        <label className="label-text" htmlFor="hyderabad">
          Hyderabad
        </label>
      </div>
      <div className="location-item">
        <input
          ...
          value="bangalore"
        />
        <label className="label-text" htmlFor="bangalore">
          Bangalore
        </label>
      </div>
      <div className="location-item">
        <input
          ...
          value="chennai"
        />
        <label className="label-text" htmlFor="chennai">
          Chennai
        </label>
      </div>
      <div className="location-item">
        <input
          ...
          value="delhi"
        />
        <label className="label-text" htmlFor="delhi">
          Delhi
        </label>
      </div>
      <div className="location-item">
        <input
          ...
          value="mumbai"
        />
        <label className="label-text" htmlFor="mumbai">
          Mumbai
        </label>
      </div>
    </div>
      ...
      <>
        ...
        <div className="jobs-bg-container">
          <div className="side-bar-container">
            ...
            <hr className="jobs-hr-line" />
            <h1 className="job-heading">Location</h1>
            {this.renderJobsByLocation()}
          </div>
